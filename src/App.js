              ...
              <div className="container-fluid p-0">
                ...
                >
                  <div className="bg-dark bg-opacity-50 p-5 rounded shadow text-white text-center">
                    ...
                    <a href="/products" className="btn btn-warning btn-lg mt-3">Browse Products</a>
                  </div>
                </div>
                ...
                <div className="container my-5 shadow" style={{ backgroundColor: '#e6d7ff' }}>
                  ...
                  <div className="row">
                    {[
                      { name: 'Emily W.', feedback: 'This platform helped me find the best laptop in minutes!', avatar: 'https://i.pravatar.cc/150?img=1' },
                      { name: 'Michael B.', feedback: 'Honest reviews that actually reflect the product. Love it!', avatar: 'https://i.pravatar.cc/150?img=2' },
                      { name: 'Sofia K.', feedback: 'The UI is sleek, and reviewing products is a breeze.', avatar: 'https://i.pravatar.cc/150?img=3' }
